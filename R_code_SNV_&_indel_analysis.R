...
## Loading VCF files 
input_folder <- "/Users/teuntjepoortvliet/surfdrive/Shared/vanBoxtelLab (Groupfolder)/Projects/Teuntje/AHH1_APH_WGS/SNV/AHH1_WT_&_FANCC_KO/"
...
file_indels_microhom <- read.csv('/Users/teuntjepoortvliet/surfdrive/Shared/vanBoxtelLab (Groupfolder)/Projects/Teuntje/AHH1_APH_WGS/SNV/AHH1_WT_&_FANCC_KO/Indel_microhomology_validation/20212904_Indels_with_microhomology_FANCC.csv', sep = ';', header = TRUE, fill = TRUE)
...
input_file_zou <- "~/Surfdrive/Shared/vanBoxtelLab (Groupfolder)/Projects/Sjors/Fanconi/Data/Zou2018/hg19/denovo_indels.txt"
...
file_genes_indels <- "/Users/teuntjepoortvliet/surfdrive/Shared/vanBoxtelLab (Groupfolder)/Projects/Teuntje/AHH1_APH_WGS/SNV/AHH1_WT_&_FANCC_KO/Indel_microhomology_validation/mart_export_indels.txt"
